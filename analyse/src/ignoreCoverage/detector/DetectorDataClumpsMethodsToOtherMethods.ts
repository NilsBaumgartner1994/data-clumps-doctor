...
export class DetectorDataClumpsMethodsToOtherMethods extends DetectorBase {
  ...
  private checkMethodParametersForDataClumps(detectContext: ContextAnalyseDataClumpParameter, otherMethod: MethodTypeContext, wholeHierarchyKnownOfClassOrInterfaceOfCurrentMethod: boolean) {
    ...
    if (otherMethodParametersAmount < this.options.sharedParametersToParametersAmountMinimum) {
    ...
    if (amountCommonParameters < this.options.sharedParametersToParametersAmountMinimum) {
      // is not a data clump
